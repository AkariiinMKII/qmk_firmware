...
SRC += usr_rgblight_layers.c # RGB light layer management
SRC += usr_layer_indicator.c # Layer indicator system library
SRC += usr_lock_indicator.c  # Lock indicator system library  
SRC += usr_led_control.c     # LED control coordination

...
#include "usr_config.h"     // Configuration constants (includes usr_rgb_colors.h)
#include "usr_rgb_layers.h" // RGB layer management
#include "usr_led_control.h" // Lock/Layer LED control
#include "usr_combo.h"      // Combo key sequences
